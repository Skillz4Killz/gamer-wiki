---
client: "Social Network Feature"
title: "Social Network Feature"
cover: "./network.png"
date: "2019-12-04"
service: "A guide to creating your own profile in the Discord Social Network."
color: "#00bfff"
---
...
First things first, we have to create our network setup on the server. Gamer comes with a command that does this automatically for us. You will need the Administrator permission on the server to run this command. Usually, you will make a private server invite Gamer and that will be your own Profile. Let's go ahead and get started.
...
- ➕ Whenever someone taps this reaction on any server, they will be able to follow/unfollow your profile.
