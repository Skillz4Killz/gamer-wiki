...
Please note, items listed in bold/italic are variables.  Ie. **_name = _**what you wish to call the emoji.  You wouldn’t type **_name_**.  In addition, **_emoji_** refers to an emoji added to the global database, not server emoji.
