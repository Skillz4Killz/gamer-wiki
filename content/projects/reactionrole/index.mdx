---
client: "Reaction Role Guide"
title: "Reaction Roles Feature"
cover: "./reactionrole.jpg"
date: "2019-11-30"
service: "A guide to creating the perfect reaction roles for your server."
color: "#f1803b"
---

import Note from "../../../src/@lekoarts/gatsby-theme-emma/components/note";

import ColorWheelGif from './colorwheel.gif';
import DevModeGif from './devmode.gif';
import EmojiCreateGif from './emojicreate.gif';
import ReactionRoleGif from './reactionrole.gif';
import ReactionRoleAddGif from './reactionroleadd.gif';
import ReactionRoleCreateGif from './reactionrolecreate.gif';
import RoleSetCreateGif from '../verification/rolesetcreate.gif';
import RoleSetsGif from '../verification/rolesets.gif';
...
- ✅ Can [create an alternate verification](http://www.linktoreactionroleverification.com) process
...
<img src={ReactionRoleGif} width="100%"></img>
...
<Note type="note">Items listed in bold/italic are variables.  Ie. **_name = _**what you wish to call the emoji.  You wouldn’t type **_name_**.  In addition, **_emoji_** refers to an emoji added to the global database, not server emoji.</Note>
...
<img src={DevModeGif} width="100%"></img>
...
<img src={EmojiCreateGif} width="100%"></img>
...
<img src={ReactionRoleCreateGif} width="100%"></img>
...
<img src={ReactionRoleAddGif} width="100%"></img>

<Note type="note">It's important to notice that while you must use reactionrolecreate in the channel with the messageID, you can use .reactionroleadd from any channel.  Due to the intricacies of coding that are beyond this humble guide-writer, it's not possible to have .reactionrolecreate run from different channels, but at least adding additional reactionroles doesn't have to mean endless botspam in your message channel.</Note>
...
<img src={ColorWheelGif} width="100%"></img>
